...
export const metadata: Metadata = {
  ...
  title: {
    default:
      "Digital Marketing & Real Estate Lead Generation Agency in Hyderabad | Époque Group",
    template: "%s | Époque Group",
  },

  description:
    "Époque Group is a leading digital marketing, SEO and real estate lead generation agency in Hyderabad specializing in Google Ads, performance marketing, luxury interiors and structured revenue growth systems for scalable business success.",
  ...
  openGraph: {
    title:
      "Digital Marketing & Real Estate Lead Generation Agency in Hyderabad | Époque Group",
    description:
      "SEO, Google Ads, performance marketing, luxury interiors and real estate lead generation services in Hyderabad designed for measurable revenue growth.",
    url: "https://epoquegroup.in",
    siteName: "Époque Group",
    images: [
      {
        url: "https://epoquegroup.in/og-image.jpg",
        width: 1200,
        height: 630,
        alt: "Époque Group Hyderabad",
      },
    ],
    locale: "en_US",
    type: "website",
  ...
  twitter: {
    ...
    title:
      "Époque Group | Digital Marketing & Real Estate Experts Hyderabad",
    description:
      "Performance-driven SEO, Google Ads, real estate lead generation and luxury interior branding services in Hyderabad.",
    images: ["https://epoquegroup.in/og-image.jpg"],
  },
  ...
  openGraph: {
    title:
      "Best Digital Marketing & Real Estate Lead Generation Agency in Hyderabad | Époque Group",
    description:
      "Époque Group is a leading digital marketing, SEO, real estate lead generation and luxury interior branding agency in Hyderabad delivering performance-driven growth systems.",
    url: "https://epoquegroup.in",
    siteName: "Époque Group",
    images: [
      {
  ...
  twitter: {
    ...
    title:
      "Époque Group | Digital Marketing & Real Estate Experts Hyderabad",
    description:
      "SEO, Google Ads, real estate lead generation and luxury interior branding specialists in Hyderabad.",
    images: ["https://epoquegroup.in/og-image.jpg"],
  },
...
export default function RootLayout({
  ...
  const localBusinessSchema = {
    ...
    name: "Époque Group",
    image: "https://epoquegroup.in/logo.png",
    url: "https://epoquegroup.in",
  ...
  const organizationSchema = {
    ...
    logo: {
      "@type": "ImageObject",
      url: "https://epoquegroup.in/logo.png",
      width: 512,
      height: 512,
    },
  };

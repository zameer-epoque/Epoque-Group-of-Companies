...
export default function AmenitiesSection() {
  return (
    ...
    >
      {/* BACKGROUND BLOBS */}
      <div className="absolute top-[-60px] left-[-60px] w-[300px] h-[300px] bg-[#C89B3C]/20 blur-[100px]" />
      <div className="absolute bottom-[-60px] right-[-60px] w-[300px] h-[300px] bg-[#2F6F68]/20 blur-[100px]" />
          ...
          {amenities.map((item, i) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.08 }}
                className="group relative rounded-2xl p-[1px] bg-gradient-to-br from-[#2F6F68]/40 via-[#C89B3C]/40 to-transparent"
              >
                <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-5 text-center hover:scale-105 transition duration-300">

                  {/* ICON */}
                  <div className="mx-auto w-12 h-12 flex items-center justify-center rounded-full bg-gradient-to-br from-[#2F6F68] to-[#C89B3C] shadow-md">

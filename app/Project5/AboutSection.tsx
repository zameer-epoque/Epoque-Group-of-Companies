...
export default function AboutSection() {
  return (
    <section
      aria-label="About Luxury Apartments Project"
      id="about"
      className="relative py-16 sm:py-20 md:py-28 bg-gradient-to-br from-[#F5F5F5] via-[#2F6F68] to-[#2F6F68] overflow-hidden text-white"
    >
      {/* GLOW EFFECTS */}
      <div className="absolute top-[-80px] left-[-80px] w-[300px] h-[300px] bg-[#C89B3C]/20 blur-[100px]" />
      <div className="absolute bottom-[-80px] right-[-80px] w-[300px] h-[300px] bg-[#2F6F68]/20 blur-[100px]" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-center">
          ...
          <motion.div
            ...
            className="relative group"
          >
            <div className="overflow-hidden rounded-3xl shadow-[0_0_30px_rgba(200,155,60,0.3)]">
              <Image
                src="/Garikipati2.jpg"
                alt="Garikipati Towers luxury apartments in Hyderabad"
                width={700}
                height={500}
                className="object-cover w-full h-[250px] md:h-auto group-hover:scale-105 transition duration-700"
              />
            </div>
            ...
            {/* BADGE */}
            <div className="absolute bottom-6 left-6 bg-white/10 backdrop-blur-xl px-5 py-3 rounded-xl border border-white/20 shadow-lg">
              <p className="text-xs text-gray-300">Premium Living</p>
              <h4 className="text-base font-semibold text-[#C89B3C]">
                Since 2026
              </h4>
            </div>
          </motion.div>
          ...
          >
            <h2 className="text-3xl md:text-6xl font-serif leading-tight mb-6">
              Premium Apartments in Hyderabad <br />
              <span className="bg-gradient-to-r from-[#2F6F68] to-[#C89B3C] text-transparent bg-clip-text">
                Designed for Modern Living
              </span>
            </h2>
            ...
            <p className="text-gray-200 text-lg mb-6 max-w-xl">
              Garikipati Towers offers luxury apartments in Hyderabad with modern
              architecture, green surroundings, and world-class amenities.
            </p>

            <div className="mt-6 w-24 h-[2px] bg-gradient-to-r from-[#2F6F68] to-[#C89B3C]" />
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-20">
          {stats.map((item, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: i * 0.1 }}
              className="p-[1px] rounded-2xl bg-gradient-to-br from-[#2F6F68]/40 via-[#C89B3C]/40 to-transparent"
            >
              <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6 text-center">

                <h3 className="text-3xl font-bold bg-gradient-to-r from-[#2F6F68] to-[#C89B3C] text-transparent bg-clip-text">
                  {item.value}
                </h3>

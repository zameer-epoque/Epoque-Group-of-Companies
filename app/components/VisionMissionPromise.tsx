            ...
            <div className="relative max-w-7xl mx-auto">
                ...
                "
                    ...
                    <p className="mt-10 text-xl md:text-2xl text-gray-400 leading-relaxed font-body">
                        The principles that guide how we think, create, and deliver
                        enduring value across every space we shape.
                    </p>
                </div>
                ...
                <div className="grid gap-14 md:grid-cols-3">
                    ...
                    <div className="group relative border border-white/10 rounded-2xl p-10 transition-all duration-300 hover:-translate-y-3 hover:border-[#C79A3B] hover:shadow-[0_0_40px_rgba(199,154,59,0.2)]">
                        ...
                        <p className="text-gray-400 leading-relaxed text-sm">
                            To be the catalyst that transforms ambition into achievement,
                            where creativity fuels commerce and culture defines legacy.
                            We envision a world where every space—digital or physical—
                            becomes a masterpiece of innovation.
                        </p>
                    </div>
                    ...
                    <div className="group relative border border-white/10 rounded-2xl p-10 transition-all duration-300 hover:-translate-y-3 hover:border-[#D45B5B] hover:shadow-[0_0_40px_rgba(212,91,91,0.2)]">
                        ...
                        <p className="text-gray-400 leading-relaxed text-sm">
                            We architect experiences that transcend expectations.
                            Through strategic insight, creative prowess, and unwavering
                            commitment, we deliver solutions that don’t just meet
                            today’s needs—they anticipate tomorrow’s possibilities.
                        </p>
                    </div>
                    ...
                    <div className="group relative border border-white/10 rounded-2xl p-10 transition-all duration-300 hover:-translate-y-3 hover:border-[#7A2E63] hover:shadow-[0_0_40px_rgba(122,46,99,0.22)]">
                        ...
                        <p className="text-gray-400 leading-relaxed text-sm">
                            Every partnership is a journey of transformation.
                            We invest not just our expertise, but our passion—ensuring
                            your vision becomes a reality that inspires, endures,
